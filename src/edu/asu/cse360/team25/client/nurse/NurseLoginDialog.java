 ...
 * @author xiangyufan
 */
public class NurseLoginDialog extends JDialog {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        NurseLoginDialog.this.nc.whichButtonOnLogin = 1;
        NurseLoginDialog.this.nc.setLoginInfo(id,
    ...
    private void signupButtonActionPerformed(java.awt.event.ActionEvent evt) {
        NurseLoginDialog.this.nc.whichButtonOnLogin = 2;
        dispose();
    }

    private void exitButtonActionPerformed(java.awt.event.ActionEvent evt) {
        NurseLoginDialog.this.nc.whichButtonOnLogin = 0;
        dispose();
    }
    /**
     *
    ...
    public NurseLoginDialog(Frame parent, NurseClient nc, int id, String password) {
